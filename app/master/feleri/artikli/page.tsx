...
export default async function FelerArticlesPage() {
      ...
      <header className="bg-white border-b border-ink-100">
        <div className="max-w-5xl mx-auto px-5 md:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold text-ink-900">Artikli</span>
          </div>
          <LogoutButton />
        </div>
      </header>
      ...
      <div className="max-w-5xl mx-auto px-5 md:px-8 py-8 space-y-6">
        <section>
          <h1 className="text-3xl font-bold tracking-tight flex items-center gap-3">
            <Package className="w-8 h-8 text-ink-700" />
            Artikli
          </h1>
          <p className="mt-1 text-ink-500">
            Šifarnik artikala za reklamacije. Pretraga po nazivu, šifri, barkodu, kasa kodu.
          </p>
        </section>
        <ArticlesClient />
      </div>
