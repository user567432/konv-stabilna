...
export default function TimGate() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const res = await fetch("/api/tim-login", {
        method: "POST",
    ...
    <main className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="card-soft mt-4">
          ...
          <h1 className="mt-5 text-2xl font-bold">TIM pristup</h1>
          <p className="text-ink-500 mt-1.5">
            Unesi PIN svoje radnje. Sistem te automatski usmerava u tvoju radnju.
          </p>
